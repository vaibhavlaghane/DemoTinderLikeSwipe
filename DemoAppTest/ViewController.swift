...
class ViewController: UIViewController {
    private var photoCollections: [UserPhotosCollectionViewController]?
    var userPhotos1: UserPhotosCollectionViewController?

    var userPhotos2: UserPhotosCollectionViewController?

    @IBOutlet var containerView: UIView!
    var userGrid: UserListViewController?
    @IBAction func handlePan(_: UIPanGestureRecognizer) {}

    var currentTopView: UserPhotosCollectionViewController?
    var currentTopGrid: UserListViewController?
...
//
        ...
        containerView.addSubview(userGrid!.view)
//        self.ch
...
//        self.embed
    ...
    func adduserGrid() {
        ...
        addChild(userGrid1)
        // userGrid?.view.bounds  = containerView.frame
        containerView.addSubview(userGrid1.view)
//        self.ch
